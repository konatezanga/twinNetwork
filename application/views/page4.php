...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url('assets/css/page4.css') ?>">
...
<h1>CONTACTS</h1>
<h3>Votre message a été envoyer avec succes
    <br>
    <br>
    Nous vous repondrons dans les plus bref delais 
</h3>
<div class="image">
	<img src="<?php echo base_url('assets/img/e-mail-removebg-preview.png') ?>" alt="" height="90" width="90">
</div>
	<footer>
		<div class="info">
			<h1>INFORMATIONS</h1>
