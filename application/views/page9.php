...
<body>
    ...
    <div class="pere">
        <div class="postule-job">
            ...
            <p>Les réceptions de candidatures se font sur le mail/numero suivant: <?php echo $stage['mail_entreprise'] ?> avec comme dossier de candidature</p>
        	<?php endforeach;
			} ?>
			...
			<?php if (isset($emplois)){
				foreach ($emplois as $emploi):
					...
					<p>Les réceptions de candidatures se font sur le mail/telephone suivant: <?php echo $emploi['mail_entreprise'] ?> </p>
				<?php endforeach;
			} ?>
		</div>
    </div>
